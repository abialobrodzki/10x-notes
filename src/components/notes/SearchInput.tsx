  ...
  return (
    <div className="relative">
      ...
      <Input
        ...
        className="relative border-glass-border bg-gradient-to-b from-glass-bg-from to-glass-bg-to pl-9 pr-9 text-glass-text placeholder:text-glass-text-muted backdrop-blur-xl"
      />
      {inputValue && (
        <Button
          variant="ghost"
